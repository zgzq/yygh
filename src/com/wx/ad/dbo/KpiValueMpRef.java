...
@Table("KPI_VALUE_MP_REF")
@View("KPI_VALUE_MP_REF_V")
@PK({ "ORGID","YEAR","KPINAME" })
public class KpiValueMpRef extends BasePO{
...
private static final long serialVersionUID = 1L;
	...
	public static final KpiValueMpRef INSTANCE = new KpiValueMpRef();
	...
	@Column(value = "totle", type = ColumnType.NUMBER)
