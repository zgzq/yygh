...
@Table("ZM_IND_DEPT_SETTLEMENT")
@View("ZM_IND_DEPT_SETTLEMENT")
@PK({ "DEPT_CODE","ORG_ID","VALUE_DATE" })
public class IndDeptSettlement extends BasePO{
...
private static final long serialVersionUID = 1L;
	...
	public static final IndDeptSettlement INSTANCE = new IndDeptSettlement();
