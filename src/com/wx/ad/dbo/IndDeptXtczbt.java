...
@Table("ZM_IND_DEPT_XTCZBT")
@View("ZM_IND_DEPT_XTCZBT")
@PK({ "DEPT_CODE","ORG_ID","VALUE_DATE" })
public class IndDeptXtczbt extends BasePO{
...
private static final long serialVersionUID = 1L;
	...
	public static final IndDeptXtczbt INSTANCE = new IndDeptXtczbt();
	...
	@Column(value = "czbt", type = ColumnType.NUMBER)
	private String czbt ;
