...
@Menu("肿瘤科住院收入统计(开单)")
@RequestMapping("/kpi/rptcancer3")
@Controller
public class RptCancer3Controller extends AuthController {
	private final String RPTNAME="zm7住院收入统计(开单)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer3Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer3/list";
	}
