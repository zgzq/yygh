...
@Menu("肿瘤科住院收入统计(执行)")
@RequestMapping("/kpi/rptcancer4")
@Controller
public class RptCancer4Controller extends AuthController {
	private final String RPTNAME="zm8住院收入统计(执行)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer4Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer4/list";
	}
