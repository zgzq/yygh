...
@Menu("肿瘤科门诊收入统计(开单)")
@RequestMapping("/kpi/rptcancer1")
@Controller
public class RptCancer1Controller extends AuthController {
	private final String RPTNAME="zm5门诊收入统计(开单)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer1Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer1/list";
	}
	...
	public GridDataModel<Record> gridData() {
		...
		List<Record> list=RptController.gridDataCan(month, RPTNAME,"-1", orgid);
