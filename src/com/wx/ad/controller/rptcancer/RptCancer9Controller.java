...
@Menu("肿瘤科全科医生开单统计")
@RequestMapping("/kpi/rptcancer9")
@Controller
public class RptCancer9Controller extends AuthController {
	private final String RPTNAME="zm肿瘤科全科医生开单统计";
	private final String ROWNAME="医生";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer9Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer9/list";
	}
