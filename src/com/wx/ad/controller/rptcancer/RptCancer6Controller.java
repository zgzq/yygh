...
@Menu("肿瘤科全科收入统计(执行)")
@RequestMapping("/kpi/rptcancer6")
@Controller
public class RptCancer6Controller extends AuthController {
	private final String RPTNAME="zm10全院收入统计(执行)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer6Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer6/list";
	}
	...
	public GridDataModel<Record> gridData() {
		...
		List<Record> list=RptController.gridDataCan1(month, RPTNAME,"-1", orgid);
