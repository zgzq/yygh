...
@Menu("肿瘤科门诊收入统计(执行)")
@RequestMapping("/kpi/rptcancer2")
@Controller
public class RptCancer2Controller extends AuthController {
	private final String RPTNAME="zm6门诊收入统计(执行)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer2Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer2/list";
	}
