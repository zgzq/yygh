...
@Menu("肿瘤科住院医生开单统计")
@RequestMapping("/kpi/rptcancer8")
@Controller
public class RptCancer8Controller extends AuthController {
	private final String RPTNAME="zm肿瘤科住院医生开单统计";
	private final String ROWNAME="医生";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer8Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer8/list";
	}
