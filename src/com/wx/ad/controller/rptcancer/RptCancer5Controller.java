...
@Menu("肿瘤科全科收入统计(开单)")
@RequestMapping("/kpi/rptcancer5")
@Controller
public class RptCancer5Controller extends AuthController {
	private final String RPTNAME="zm9全院收入统计(开单)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptCancer5Controller.class);
	...
	public String index(Model m) {
		...
		return "admin/rptcancer/rptcancer5/list";
	}
