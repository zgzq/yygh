...
@Menu("(动态)中美中的誉美")
@RequestMapping("/kpi/rptdtym2")
@Controller
public class RptDtYm2 extends AuthController{
	private int orgid=21;//中美中的誉美
	
	@Action("(动态)中美中的誉美")
	@RequestMapping("/listym2")
	...
	public String download() {
		...
		String filename="(动态)中美中的誉美"+sdate+"-"+edate;
