...
@Menu("(动态)誉美中的中美")
@RequestMapping("/kpi/rptdtzm2")
@Controller
public class RptDtZm2 extends AuthController{
	private int orgid=12;//誉美中的中美
	
	@Action("(动态)誉美中的中美")
	@RequestMapping("/listzm2")
	...
	public String download() {
		...
		String filename="(动态)誉美中的中美"+sdate+"-"+edate;
