...
@Menu("zm11全院开单医生统计")
@RequestMapping("/kpi/rptzm11")
@Controller
public class RptZm11Controller extends AuthController {
	private final String RPTNAME="zm11全院开单医生统计";
	...
	public String index(Model m) {
		...
		return "admin/rptzm/rptzm11/list";
	}
