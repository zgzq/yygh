package com.wx.ad.controller.rptzm;
...
@Menu("zm10全院收入统计(执行)")
@RequestMapping("/kpi/rptzm10")
@Controller
public class RptZm10Controller extends AuthController {
	private final String RPTNAME="zm10全院收入统计(执行)";
	private final String ROWNAME="科室";
	private int orgid=1;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptZm1Controller.class);

	@Action("zm10全院收入统计(执行)")
	@RequestMapping("/list")
	public String index(Model m) {
		...
		return "admin/rptzm/rptzm10/list";
	}
