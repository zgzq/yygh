...
@Menu("河南誉美综合")
@RequestMapping("/kpi/hnym")
@Controller
public class HnymKpiController extends AuthController {
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(HnymKpiController.class);

	@Action("河南誉美综合")
	@RequestMapping("/list")
	public String index() {
		return "admin/hnymrpt/list";
	}
...
//			}
	...
	public String download() {
		...
		String filename="河南誉美综合指标"+sdate+"-"+edate;
