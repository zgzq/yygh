...
import my.ann.Menu;
@Menu("(合并)中美中的誉美")
@RequestMapping("/kpi/rpthbym2")
@Controller
public class RptHbYm2  extends AuthController{
	private int orgid=21;
	...
	public String download() {
		...
		String filename="(合并)中美中的誉美"+sdate+"-"+edate;
