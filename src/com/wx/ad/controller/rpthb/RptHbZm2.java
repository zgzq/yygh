...
import my.ann.Menu;
@Menu("(合并)誉美中的中美")
@RequestMapping("/kpi/rpthbzm2")
@Controller
public class RptHbZm2  extends AuthController{
	private int orgid=12;
	...
	public String download() {
		...
		String filename="(合并)誉美中的中美"+sdate+"-"+edate;
