...
import my.ann.Menu;
@Menu("(合并)中美")
@RequestMapping("/kpi/rpthbzm")
@Controller
public class RptHbZm  extends AuthController{
	private int orgid=1;
	...
	public String download() {
		...
		String filename="(合并)中美"+sdate+"-"+edate;
		...
		String column = "mzks,hj,cz,fz,jz,zj,zyks,yys,rys,zrs,cys,zcs,xys,sjy,kfs,bcyl,jc,kc";
