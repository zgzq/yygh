...
@Menu("常德惠民综合")
@RequestMapping("/kpi/cdhm")
@Controller
public class CdhmKpiController extends AuthController {
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(CdhmKpiController.class);

	@Action("常德惠民综合")
	@RequestMapping("/list")
	public String index() {
		return "admin/cdhmrpt/list";
	}
	@Action("常德惠民血透")
	@RequestMapping("/listxt")
	public String indexxt() {
		return "admin/cdhmrpt/listxt";
	}
...
//			}
	...
	public String download() {
		...
		String filename="常德惠民综合指标"+sdate+"-"+edate;
