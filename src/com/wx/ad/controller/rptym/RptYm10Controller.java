...
@Menu("ym10全院收入统计(执行)")
@RequestMapping("/kpi/rptym10")
@Controller
public class RptYm10Controller extends AuthController {
	private final String RPTNAME="ym10全院收入统计(执行)";
	private final String ROWNAME="科室";
	private int orgid=2;
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(RptYm1Controller.class);

	@Action("ym10全院收入统计(执行)")
	@RequestMapping("/list")
	public String index(Model m) {
		...
		return "admin/rptym/rptym10/list";
	}
