...
@Menu("ym11全院开单医生统计")
@RequestMapping("/kpi/rptym11")
@Controller
public class RptYm11Controller extends AuthController {
	private final String RPTNAME="ym11全院开单医生统计";
	...
	public String index(Model m) {
		...
		return "admin/rptym/rptym11/list";
	}
