...
@Menu("京美医院综合")
@RequestMapping("/kpi/jm")
@Controller
public class JmKpiController extends AuthController {
	private static Logger logger = org.slf4j.LoggerFactory
			.getLogger(JmKpiController.class);

	@Action("京美医院综合")
	@RequestMapping("/list")
	public String index() {
		return "admin/jmrpt/list";
	}
...
//			}
	...
	public String download() {
		...
		String filename="京美医院综合指标"+sdate+"-"+edate;
