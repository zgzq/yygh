...
<body>
	<div id="center-panel">
		...
		<form name=form1 action="${pageContext.request.contextPath}/kpi/rptym11/download" method="post" target="newWin">  
		...
		$(document)
				.ready(
						function() {
							...
							//动态获取列（初始化）
							$.post(WEB_ROOT + "/kpi/rptym11/gridColumn",{month:month},
									function(jsonData){
										$('#grid').omGrid(
												{
													dataSource:"",
												...
												btns : [
														{
															...
															onClick : function() {
																...
																//动态获取列
																$.post(WEB_ROOT + "/kpi/rptym11/gridColumn",{month:month},/* {sdate:sdate,edate:edate,}, */
																		function(jsonData){
																			$('#grid').omGrid(
																					{
																						dataSource:"",
																...
																$('#grid').omGrid("setData",WEB_ROOT + "/kpi/rptym11/gridData"); 
