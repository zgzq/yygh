...
<body>
	...
	<form name=form1 action="${pageContext.request.contextPath}/kpi/rpthbzm/download" method="post" target="newWin">  
												...
												btns : [
														{
															...
															onClick : function() {
																...
																$('#grid').omGrid("setData",WEB_ROOT + "/kpi/rpthbzm/gridData?month="+month); 
															}
														},
														{
															separtor : false
