...
<body>
	...
	<form name=form1 action="${pageContext.request.contextPath}/kpi/rpthbym/download" method="post" target="newWin">  
												...
												btns : [
														{
															...
															onClick : function() {
																...
																$('#grid').omGrid("setData",WEB_ROOT + "/kpi/rpthbym/gridData?month="+month); 
															}
														},
														{
															separtor : false
