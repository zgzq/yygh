...
<body>
	...
	<form name=form1 action="${pageContext.request.contextPath}/kpi/rpthbym2/download" method="post" target="newWin">  
												...
												btns : [
														{
															...
															onClick : function() {
																...
																$('#grid').omGrid("setData",WEB_ROOT + "/kpi/rpthbym2/gridData?month="+month); 
															}
														},
														{
															separtor : false
