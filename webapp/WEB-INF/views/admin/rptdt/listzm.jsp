...
<body>
	...
	<form name=form1 action="${pageContext.request.contextPath}/kpi/rptdtzm/download" method="post" target="newWin">  
												...
												btns : [
														{
															...
															onClick : function() {
																...
																$('#grid').omGrid("setData",WEB_ROOT + "/kpi/rptdtzm/gridData?month="+month); 
															}
														},
														{
															separtor : false
