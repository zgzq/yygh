...
<body>
	...
	<form name=form1 action="${pageContext.request.contextPath}/kpi/rptdtym/download" method="post" target="newWin">  
												...
												btns : [
														{
															...
															onClick : function() {
																...
																$('#grid').omGrid("setData",WEB_ROOT + "/kpi/rptdtym/gridData?month="+month); 
															}
														},
														{
															separtor : false
