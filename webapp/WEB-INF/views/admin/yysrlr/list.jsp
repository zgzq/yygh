...
<body>
	<div id="center-panel">
		...
		<div id="search-panel">
			<form id="queryform">
				<span class="label">所属医院：</span> <select class="input-text" name="orgquery"
							id="orgquery" style="height: 22px">
								<option></option>
						</select> <span class="label">起始日期:</span><input
