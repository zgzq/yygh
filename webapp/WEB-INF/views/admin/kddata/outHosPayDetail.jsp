...
<script type="text/javascript">
	...
	function refresh() {
		...
		$("#dg").datagrid({
			url : WEB_ROOT + '/kd/outPatPay/gridData?'+$('#fmQuery').serialize()
		});
	...
	function exportExl(){
		...
		var url = WEB_ROOT + '/kd/outPatPay/export?month='+$("#month").val()+"&year="+
	...
	function reset(){
		$.ajax({
            ...
            type: "Post",
            //方法所在页面和方法名   
            url: WEB_ROOT + '/kd/outPatPay/geneData?orgid='+ $("#orgid").val()
